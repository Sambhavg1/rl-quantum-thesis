...
OUTPUT_DIR = f"results_ame52_converge_{TIMESTAMP}"
...
class MaskedPPOAgent:
    def __init__(self, n_actions, n_features, initial_lr=3e-4, decay_steps=10000):
        ...
        self.clip_ratio = 0.25      
        self.policy_epochs = 30     
        self.batch_size = 512
        self.initial_entropy = 0.02 
        
        # <--- BUG FIX: Add decay_steps here --->
    ...
    def learn(self):
        ...
        # <--- BUG FIX: Safe division to prevent division by zero --->
...
if __name__ == '__main__':
    ...
    print(f"--- Starting Action-Masked AME(5,2) Convergence Run ---")
