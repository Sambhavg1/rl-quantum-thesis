#!/bin/bash
#SBATCH --job-name=AME46_MAC_CONV
#SBATCH --output=ame46_mac_conv_%j.out
#SBATCH --error=ame46_mac_conv_err_%j.log
...
echo "=========================================="
echo "Starting Bulbasaur AME(4,6) Search..."
...
$PYTHON_PATH ame46_3nc_with_penalty.py
