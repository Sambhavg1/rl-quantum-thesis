...
class PPOAgent:
    def __init__(
        ...
        # --- HPC FIX: Restored Standard Optimizers ---
...
if __name__ == '__main__':
    ...
    agent = PPOAgent(
        ...
        initial_lr=1e-4,
        final_lr=1e-6,
        decay_steps=EPISODES,     # polynomial decay over episodes
        gamma=0.99,
        clip_ratio=0.1,
        policy_epochs=10,
        batch_size=4096,
    ...
    # Optional: Sort descending by entropy so best result is at the top
